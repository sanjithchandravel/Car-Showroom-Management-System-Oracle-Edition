...
public class DeleteEmployee extends javax.swing.JFrame {
     ...
     * @param user
     */
    public DeleteEmployee(String user) {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                if(s1.equals(user))
                {
                    String s12 = rs.getString("sid");
                    jLabel11.setText(s12);
                    String s13 = rs.getString("empname");
                    jLabel5.setText(s13);
                    String s2 = rs.getString("Address");
                    jLabel6.setText(s2);
                    String s15 = rs.getString("age");
                    jLabel14.setText(s15);
                    String s14 = rs.getString("salary");
                    jLabel12.setText(s14);
                    String s4 = rs.getString("MobileNo");
                    jLabel7.setText(s4);
                    String s5 = rs.getString("EmailId");
                    jLabel9.setText(s5);
                    String s6 = rs.getString("designation");
                    jLabel8.setText(s6);
                    i++;
                }
            }
    ...
    private void initComponents() {
        ...
        getContentPane().add(l1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, 170, -1));
        ...
        l3.setText("Mobileno");
        getContentPane().add(l3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 310, 110, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 200, 150, -1));
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 200, 110, 30));
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 140, -1, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 0, 0));
        jLabel14.setText("XXXXXXX");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 140, -1, -1));

        l10.setIcon(new javax.swing.ImageIcon("C:\\Users\\Sanjith\\Downloads\\speedometer.jpg")); // NOI18N
        getContentPane().add(l10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1560, 840));
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        try 
        {
            ...
            if(c1.isSelected())
            {
                ...
                cstmt = con.prepareCall("{CALL delemp(?)}");
                cstmt.setString(1, jLabel10.getText());
                cstmt.execute();
                cstmt.close();
                /*String query = "{call delemp(?)}"; 
                CallableStatement statement = connection.prepareCall(query);  
                statement.setString(1, jLabel10.getText());  
                statement.execute(); */
                //String q1 = "DELETE FROM employee WHERE empid = '"+jLabel10.getText()+"'";
                /*String q2="execute delemp('"+jLabel10.getText()+"')";
